...
const ConsultorDashboard: React.FC<ConsultorDashboardProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-end">
        <div>
          <h2 className="text-3xl font-black text-gray-900 tracking-tight">Minhas Solicitações</h2>
          <p className="text-gray-500 mt-1">Gerencie os pedidos de desconto vinculados ao seu perfil.</p>
        </div>
        <button
